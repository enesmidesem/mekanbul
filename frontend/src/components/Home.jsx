...
// Ana sayfa bileşeni
  ...
  const isLoading = useSelector((state) => state.isLoading); // (Yükleniyor durumu)
  const isError = useSelector((state) => state.isError);     // (Hata durumu)
  const isSuccess = useSelector((state) => state.isSuccess); // (Başarı durumu)
